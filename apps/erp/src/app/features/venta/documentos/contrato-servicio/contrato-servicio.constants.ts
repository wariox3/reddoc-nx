...
export const CONTRATO_SERVICIO_COLUMNS: readonly ColumnDef[] = [
  ...
  {
    field: 'horas',
    headerKey: 'entities.contratoServicio.columns.horas',
    type: 'number',
    width: '100px',
    align: 'right',
    sortable: true,
  ...
  {
    field: 'horas_diurnas',
    headerKey: 'entities.contratoServicio.columns.horasDiurnas',
    type: 'number',
    width: '110px',
    align: 'right',
    sortable: true,
  },
  {
    ...
    headerKey: 'entities.contratoServicio.columns.horasNocturnas',
    type: 'number',
    width: '110px',
    align: 'right',
    sortable: true,
