 ...
 *
 * Acordeones: "Documentos" (contrato/pedido/factura de servicio) e "Informes"
 * (Pendiente por facturar). Sumar entradas a `items` (o nuevos grupos/acordeones)
 * cuando se implementen más documentos o informes.
 */
