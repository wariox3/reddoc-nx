...
export const PUESTOS_COLUMNS: readonly ColumnDef[] = [
  ...
  { field: 'nombre', headerKey: 'entities.puesto.columns.nombre', type: 'text', sortable: true },
  ...
  { field: 'latitud', headerKey: 'entities.puesto.columns.latitud', type: 'text' },
  { field: 'longitud', headerKey: 'entities.puesto.columns.longitud', type: 'text' },
  { field: 'comentario', headerKey: 'entities.puesto.columns.comentario', type: 'text' },
  {
